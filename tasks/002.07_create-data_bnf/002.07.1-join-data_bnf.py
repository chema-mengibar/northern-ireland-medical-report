...
dfZV2 = dfZ.groupby(['CHAPTER', 'SECTION', 'PARAGRAPH' ]).size().to_frame('size').reset_index()
dfZV3 = dfZV2.drop(['size'], axis=1)
dfZV4 = dfZV3.sort_values(by=['CHAPTER', 'SECTION', 'PARAGRAPH' ])
...
#com: save file
dfZV4.to_csv( path_or_buf=outputFilePath, sep="|", quoting=None, index=False, decimal=',' )
